...
const Hero = () => {
 ...
 items-center justify-betwen min-h-[calc(90vh-6rem)]">
...
<i class='bx bx-diamond'></i> INRODUCING 
    </div>
</div>
...
<div className='flex gap-4 mt-12'>
    ...
    sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a]' href="">
        DOCUMENTATION <i class='bx bx-link-external'></i>
    </a>
      <a className='border border-[#2a2a2a]
    py-2 sm:py-3 px-4 sm:px-10 rounded-full 
    sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white' href="">
        GETSTARTED<i class='bx bx-link-external'></i>
    </a>
</div>
</div>
 <Spline data-ao="fade-zoom-in"
 data-aos-easing="ease-in-back"
 data-aos-delay="300"
 data-aos-offset="0" data-aos-duration="3000" className='absolute lg:top-0 top-[-20%]
 bottom-0 lg:left-[25%] sm:left-[-2%] h-full' scene="https://prod.spline.design/61ZlmyAJvhSGgQRQ/scene.splinecode" />
 </main>
  )
}
